...
<div style="padding-top: 20px;" class="container">
		...
		<div>
			<a href='/PromotionController/createDiscountCode'> Create discount code </a>
		</div>
...
<?php
	...
	foreach($data['promotions'] as $promotion){
								...
								echo        "<td>$promotion->promotion_code</td>";
								echo        "<td>$promotion->percentOff</td>";
								echo        "<td><a href='PromotionController/editDiscountCode/$promotion->promotion_Id'> Edit Code </a></td>";
								echo        "<td><a href='PromotionController/deleteDiscountCode/$promotion->promotion_Id'> Delete Code </a></td>";
								echo	"</tr>";
	}
?>  
		  </tbody>
...
<a href='PromotionController/createDiscountCode'> Create discount code </a>
	...
	<?php 
	foreach($data['promotions'] as $promotion){
		echo "<p>$promotion->promotion_code</p>";
		echo "<p>$promotion->percentOff</p>";
		echo "<a href='PromotionController/editDiscountCode/$promotion->promotion_Id'> Edit Code </a> <br/>";
		echo "<a href='PromotionController/deleteDiscountCode/$promotion->promotion_Id'> Delete Code </a>";
		echo "<br/> =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=";
	}
	?>
