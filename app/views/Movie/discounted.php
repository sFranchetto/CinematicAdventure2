         ...
         <div class="row">
            <div class="col-lg-3">
               ...
               <div class="list-group">
                  ...
                  <a href="/MovieController/discounted" class="list-group-item active">Discounted Movies</a>
               </div>
            </div>
            <!-- /.col-lg-3 -->
            <div class="col-lg-9">
    ...
    <div class="row">
				<?php 
                  foreach($data['movies'] as $movie){
						  ...
						  echo       "<a href='/MovieController/Details/$movie->movie_Id'><img class='card-img-top' src='/$movie->image_path' width='242.984px' height='350px'></a>";
						  echo      "<div class='card-body'>";
						  echo     "<h4 class='card-title'>";
						  echo    "<a href='/MovieController/Details/$movie->movie_Id'>$movie->title</a>";
						  echo "</h4>";
						  echo      "<strike><h5>$$movie->price</h5></strike>";
                    $newprice = $movie->price * .45;
                    echo      "<br><h5>$$newprice</h5>";
						  ...
						  echo "<div>";
						  echo "<a style='text-align: right' class='nav-link' href='$movie->trailer'target='_blank'>Watch Trailer</a>";
						  echo "</div>";
...
foreach($data['movies'] as $movie){
		...
		echo "<a href='OrderDetailController/addToCart/$movie->movie_Id'> Add to cart </a>";
		echo "<a href='WishListController/addToWishList/$movie->movie_Id'> Add to wishlist </a>";
		echo "<br/> <a href='/MovieController/Details/$movie->movie_Id'> Movie Details </a>";
