...
<div style="padding-top: 20px;" class="container">
	...
	<div>
	<a href="insertNewMovie"> Add a new movie </a>
	</div>
	<div  style="text-align:center; padding-top: 20px;">
	<h4><p><strong>
	List of Available and Upcoming Movies
	</strong></p></h4>
	</div>
	<div>	
...
<?php
	foreach($data['movies'] as $movie){
								...
								echo        "<td><a href='editMovie/$movie->movie_Id'> Edit Movie </a></td>";
								echo        "<td><a href='deleteFromListing/$movie->movie_Id'> Delete Movie </a></td>";
								echo	"</tr>";
	}
?>  
		  </tbody>
